...
class Route {
    ...
    $name = null, $path = null, $params = null, $values = null, $method = null, $secure = null, $routable = true, $is_match = null, $generate = null, $name_prefix = null, $path_prefix = null
    ) {
    ...
    public function isMatch($path, array $server) {
        ...
        $is_match = $this->isRegexMatch($path) && $this->isMethodMatch($server) && $this->isSecureMatch($server) && $this->isCustomMatch($server);

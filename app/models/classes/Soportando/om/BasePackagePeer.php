...
abstract class BasePackagePeer
{
    ...
    const PROJECT_ID = 'package.project_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('PackageId', 'ProjectId', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('packageId', 'projectId', 'name', ),
        BasePeer::TYPE_COLNAME => array (PackagePeer::PACKAGE_ID, PackagePeer::PROJECT_ID, PackagePeer::NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PACKAGE_ID', 'PROJECT_ID', 'NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('package_id', 'project_id', 'name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('PackageId' => 0, 'ProjectId' => 1, 'Name' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('packageId' => 0, 'projectId' => 1, 'name' => 2, ),
        BasePeer::TYPE_COLNAME => array (PackagePeer::PACKAGE_ID => 0, PackagePeer::PROJECT_ID => 1, PackagePeer::NAME => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PACKAGE_ID' => 0, 'PROJECT_ID' => 1, 'NAME' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('package_id' => 0, 'project_id' => 1, 'name' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PackagePeer::PACKAGE_ID);
            $criteria->addSelectColumn(PackagePeer::PROJECT_ID);
    ...
    public static function doCountJoinProject(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PackagePeer::PROJECT_ID, ProjectPeer::PROJECT_ID, $join_behavior);
    ...
    /**
     * Selects a collection of Package objects pre-filled with their Project objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinProject(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PackagePeer::addSelectColumns($criteria);
        $startcol = PackagePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = PackagePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = PackagePeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                PackagePeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Package) to $obj2 (Project)
                $obj2->addPackage($obj1);
    ...
    /**
     * Selects a collection of Package objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PackagePeer::addSelectColumns($criteria);
        $startcol2 = PackagePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Package) to the collection in $obj2 (Project)
                $obj2->addPackage($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(PackagePeer::PACKAGE_ID) && $criteria->keyContainsValue(PackagePeer::PACKAGE_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(PackagePeer::PACKAGE_ID);
            $value = $criteria->remove(PackagePeer::PACKAGE_ID);
            if ($value) {
                $selectCriteria->add(PackagePeer::PACKAGE_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(PackagePeer::PACKAGE_ID, (array) $values, Criteria::IN);
        }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(ModulePeer::PACKAGE_ID, $obj->getPackageId());
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(PackagePeer::DATABASE_NAME);
        $criteria->add(PackagePeer::PACKAGE_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(PackagePeer::DATABASE_NAME);
            $criteria->add(PackagePeer::PACKAGE_ID, $pks, Criteria::IN);

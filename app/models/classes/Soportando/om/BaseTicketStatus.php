...
/**
 * Base class that represents a row from the 'ticket_status' table.
 *
 *
 *
 * @package    propel.generator.Soportando.om
 */
abstract class BaseTicketStatus extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'TicketStatusPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TicketStatusPeer
     */
     ...
     * @return TicketStatus The current object (for fluent API support)
     */
    public function setTicketStatusId($v)
    {
        ...
        if ($this->ticket_status_id !== $v) {
            ...
            $this->modifiedColumns[] = TicketStatusPeer::TICKET_STATUS_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = TicketStatusPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->ticket_status_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 2; // 2 = TicketStatusPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TicketStatus object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TicketStatusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TicketStatusQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TicketStatusPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TicketStatusPeer::TICKET_STATUS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`ticket_status_id`';
        }
        if ($this->isColumnModified(TicketStatusPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `ticket_status` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TicketStatusPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TicketStatusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TicketStatus'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TicketStatus'][$this->getPrimaryKey()] = true;
        $keys = TicketStatusPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getTicketStatusId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setTicketStatusId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TicketStatusPeer::TICKET_STATUS_ID)) $criteria->add(TicketStatusPeer::TICKET_STATUS_ID, $this->ticket_status_id);
        if ($this->isColumnModified(TicketStatusPeer::NAME)) $criteria->add(TicketStatusPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(TicketStatusPeer::DATABASE_NAME);
        $criteria->add(TicketStatusPeer::TICKET_STATUS_ID, $this->ticket_status_id);
    ...
    /**
     * Generic method to set the primary key (ticket_status_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getTicketStatusId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of TicketStatus (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setTicketStatusId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TicketStatus Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (self::$peer === null) {
            self::$peer = new TicketStatusPeer();
        }
     ...
     * If this TicketStatus is new, it will return
    ...
    public function setTickets(PropelCollection $tickets, PropelPDO $con = null)
    {
        ...
        foreach ($ticketsToDelete as $ticketRemoved) {
            $ticketRemoved->setTicketStatus(null);
        }
     ...
     * Otherwise if this TicketStatus is new, it will return
     * an empty collection; or if this TicketStatus has previously
     * been saved, it will retrieve related Tickets from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TicketStatus.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setTicketHistorys(PropelCollection $ticketHistorys, PropelPDO $con = null)
    {
        ...
        foreach ($ticketHistorysToDelete as $ticketHistoryRemoved) {
            $ticketHistoryRemoved->setTicketStatus(null);
        }
    ...
    protected function doAddTicketHistory($ticketHistory)
    {
        ...
        $ticketHistory->setTicketStatus($this);
    }
    ...
    public function removeTicketHistory($ticketHistory)
    {
        if ($this->getTicketHistorys()->contains($ticketHistory)) {
            ...
            $ticketHistory->setTicketStatus(null);
        }
    ...
    {
        return (string) $this->exportTo(TicketStatusPeer::DEFAULT_STRING_FORMAT);
    }

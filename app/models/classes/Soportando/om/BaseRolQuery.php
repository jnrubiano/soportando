 ...
 *
 *
 * @method RolQuery orderByRid($order = Criteria::ASC) Order by the rid column
 * @method RolQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method RolQuery groupByRid() Group by the rid column
 * @method RolQuery groupByName() Group by the name column
 *
 ...
 *
 * @method RolQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method RolQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method RolQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
 ...
 *
 * @method Rol findOneByName(string $name) Return the first Rol filtered by the name column
 *
 * @method array findByRid(int $rid) Return Rol objects filtered by the rid column
 * @method array findByName(string $name) Return Rol objects filtered by the name column
 *
...
abstract class BaseRolQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'Soportando', $modelName = 'Rol', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `rid`, `name` FROM `rol` WHERE `rid` = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(RolPeer::RID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(RolPeer::RID, $keys, Criteria::IN);
    }
    ...
    public function filterByRid($rid = null, $comparison = null)
    {
        if (is_array($rid)) {
            $useMinMax = false;
            if (isset($rid['min'])) {
                $this->addUsingAlias(RolPeer::RID, $rid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($rid['max'])) {
                $this->addUsingAlias(RolPeer::RID, $rid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RolPeer::RID, $rid, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RolPeer::NAME, $name, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(RolPeer::RID, $user->getRid(), $comparison);
    ...
    {
        if ($rol) {
            $this->addUsingAlias(RolPeer::RID, $rol->getRid(), Criteria::NOT_EQUAL);
        }

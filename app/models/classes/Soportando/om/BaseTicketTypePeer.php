...
abstract class BaseTicketTypePeer
{
    ...
    const TICKET_TYPE_ID = 'ticket_type.ticket_type_id';

    /** the column name for the name field */
    const NAME = 'ticket_type.name';
     ...
     * e.g. TicketTypePeer::$fieldNames[TicketTypePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('TicketTypeId', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('ticketTypeId', 'name', ),
        BasePeer::TYPE_COLNAME => array (TicketTypePeer::TICKET_TYPE_ID, TicketTypePeer::NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('TICKET_TYPE_ID', 'NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('ticket_type_id', 'name', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. TicketTypePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('TicketTypeId' => 0, 'Name' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('ticketTypeId' => 0, 'name' => 1, ),
        BasePeer::TYPE_COLNAME => array (TicketTypePeer::TICKET_TYPE_ID => 0, TicketTypePeer::NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('TICKET_TYPE_ID' => 0, 'NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('ticket_type_id' => 0, 'name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        $toNames = TicketTypePeer::getFieldNames($toType);
        $key = isset(TicketTypePeer::$fieldKeys[$fromType][$name]) ? TicketTypePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(TicketTypePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, TicketTypePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return TicketTypePeer::$fieldNames[$type];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TicketTypePeer::TICKET_TYPE_ID);
            $criteria->addSelectColumn(TicketTypePeer::NAME);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(TicketTypePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(TicketTypePeer::DATABASE_NAME);
     ...
     *
     * @param      TicketType $obj A TicketType object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = (string) $obj->getTicketTypeId();
            } // if key === null
            TicketTypePeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof TicketType) {
                $key = (string) $value->getTicketTypeId();
            ...
            unset(TicketTypePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(TicketTypePeer::$instances[$key])) {
                return TicketTypePeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (TicketTypePeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        TicketTypePeer::$instances = array();
    }
    ...
    {
        $key = TicketTypePeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = TicketTypePeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + TicketTypePeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = TicketTypePeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Propel::getDatabaseMap(TicketTypePeer::DATABASE_NAME)->getTable(TicketTypePeer::TABLE_NAME);
    }
    ...
    {
        return TicketTypePeer::OM_CLASS;
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(TicketTypePeer::TICKET_TYPE_ID) && $criteria->keyContainsValue(TicketTypePeer::TICKET_TYPE_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.TicketTypePeer::TICKET_TYPE_ID.')');
        }
    ...
    /**
     * Performs an UPDATE on the database, given a TicketType or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(TicketTypePeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(TicketTypePeer::TICKET_TYPE_ID);
            $value = $criteria->remove(TicketTypePeer::TICKET_TYPE_ID);
            if ($value) {
                $selectCriteria->add(TicketTypePeer::TICKET_TYPE_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(TicketTypePeer::TABLE_NAME);
            }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += TicketTypePeer::doOnDeleteCascade(new Criteria(TicketTypePeer::DATABASE_NAME), $con);
            $affectedRows += BasePeer::doDeleteAll(TicketTypePeer::TABLE_NAME, $con, TicketTypePeer::DATABASE_NAME);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(TicketTypePeer::TICKET_TYPE_ID, (array) $values, Criteria::IN);
        }
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += TicketTypePeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = TicketTypePeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(TicketPeer::TICKET_TYPE_ID, $obj->getTicketTypeId());
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(TicketTypePeer::DATABASE_NAME);
        $criteria->add(TicketTypePeer::TICKET_TYPE_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(TicketTypePeer::DATABASE_NAME);
            $criteria->add(TicketTypePeer::TICKET_TYPE_ID, $pks, Criteria::IN);

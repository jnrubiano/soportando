...
/**
 * Base class that represents a row from the 'ticket_priority' table.
 *
 *
 *
 * @package    propel.generator.Soportando.om
 */
abstract class BaseTicketPriority extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'TicketPriorityPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TicketPriorityPeer
     */
     ...
     * @return TicketPriority The current object (for fluent API support)
     */
    public function setPriorityId($v)
    {
        ...
        if ($this->priority_id !== $v) {
            $this->priority_id = $v;
            $this->modifiedColumns[] = TicketPriorityPeer::PRIORITY_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = TicketPriorityPeer::NAME;
        }
    ...
    public function setOrder($v)
    {
        ...
        if ($this->order !== $v) {
            $this->order = $v;
            $this->modifiedColumns[] = TicketPriorityPeer::ORDER;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->priority_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = TicketPriorityPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TicketPriority object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TicketPriorityPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TicketPriorityQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TicketPriorityPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TicketPriorityPeer::PRIORITY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`priority_id`';
        }
        if ($this->isColumnModified(TicketPriorityPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(TicketPriorityPeer::ORDER)) {
            $modifiedColumns[':p' . $index++]  = '`order`';
        }

        $sql = sprintf(
            'INSERT INTO `ticket_priority` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TicketPriorityPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TicketPriorityPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TicketPriority'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TicketPriority'][$this->getPrimaryKey()] = true;
        $keys = TicketPriorityPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getPriorityId(),
            $keys[1] => $this->getName(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setPriorityId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TicketPriorityPeer::PRIORITY_ID)) $criteria->add(TicketPriorityPeer::PRIORITY_ID, $this->priority_id);
        if ($this->isColumnModified(TicketPriorityPeer::NAME)) $criteria->add(TicketPriorityPeer::NAME, $this->name);
        if ($this->isColumnModified(TicketPriorityPeer::ORDER)) $criteria->add(TicketPriorityPeer::ORDER, $this->order);
    ...
    {
        $criteria = new Criteria(TicketPriorityPeer::DATABASE_NAME);
        $criteria->add(TicketPriorityPeer::PRIORITY_ID, $this->priority_id);
    ...
    /**
     * Generic method to set the primary key (priority_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getPriorityId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of TicketPriority (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setPriorityId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TicketPriority Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TicketPriorityPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TicketPriorityPeer();
        }
     ...
     * If this TicketPriority is new, it will return
    ...
    public function setTickets(PropelCollection $tickets, PropelPDO $con = null)
    {
        ...
        foreach ($ticketsToDelete as $ticketRemoved) {
            $ticketRemoved->setTicketPriority(null);
        }
     ...
     * Otherwise if this TicketPriority is new, it will return
     * an empty collection; or if this TicketPriority has previously
     * been saved, it will retrieve related Tickets from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TicketPriority.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(TicketPriorityPeer::DEFAULT_STRING_FORMAT);
    }

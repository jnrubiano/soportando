...
/**
 * Base class that represents a row from the 'engineer' table.
 *
 *
 *
 * @package    propel.generator.Soportando.om
 */
abstract class BaseEngineer extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'EngineerPeer';
     ...
     * @return Engineer The current object (for fluent API support)
     */
    public function setEngineerId($v)
    {
        ...
        if ($this->engineer_id !== $v) {
            $this->engineer_id = $v;
            $this->modifiedColumns[] = EngineerPeer::ENGINEER_ID;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[] = EngineerPeer::UID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = EngineerPeer::NAME;
        }
    ...
    public function setSpecialty($v)
    {
        ...
        if ($this->specialty !== $v) {
            $this->specialty = $v;
            $this->modifiedColumns[] = EngineerPeer::SPECIALTY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->engineer_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->uid = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->specialty = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = EngineerPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Engineer object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EngineerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EngineerQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EngineerPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = EngineerPeer::ENGINEER_ID;
        if (null !== $this->engineer_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . EngineerPeer::ENGINEER_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(EngineerPeer::ENGINEER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`engineer_id`';
        }
        if ($this->isColumnModified(EngineerPeer::UID)) {
            $modifiedColumns[':p' . $index++]  = '`uid`';
        }
        if ($this->isColumnModified(EngineerPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(EngineerPeer::SPECIALTY)) {
            $modifiedColumns[':p' . $index++]  = '`specialty`';
        }

        $sql = sprintf(
            'INSERT INTO `engineer` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EngineerPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EngineerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Engineer'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Engineer'][$this->getPrimaryKey()] = true;
        $keys = EngineerPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getEngineerId(),
            $keys[1] => $this->getUid(),
            $keys[2] => $this->getName(),
            $keys[3] => $this->getSpecialty(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setEngineerId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setUid($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setName($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setSpecialty($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EngineerPeer::ENGINEER_ID)) $criteria->add(EngineerPeer::ENGINEER_ID, $this->engineer_id);
        if ($this->isColumnModified(EngineerPeer::UID)) $criteria->add(EngineerPeer::UID, $this->uid);
        if ($this->isColumnModified(EngineerPeer::NAME)) $criteria->add(EngineerPeer::NAME, $this->name);
        if ($this->isColumnModified(EngineerPeer::SPECIALTY)) $criteria->add(EngineerPeer::SPECIALTY, $this->specialty);
    ...
    {
        $criteria = new Criteria(EngineerPeer::DATABASE_NAME);
        $criteria->add(EngineerPeer::ENGINEER_ID, $this->engineer_id);
    ...
    /**
     * Generic method to set the primary key (engineer_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getEngineerId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Engineer (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setEngineerId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Engineer Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Engineer is new, it will return
    ...
    public function setTickets(PropelCollection $tickets, PropelPDO $con = null)
    {
        ...
        foreach ($ticketsToDelete as $ticketRemoved) {
            $ticketRemoved->setEngineer(null);
        }
     ...
     * Otherwise if this Engineer is new, it will return
     * an empty collection; or if this Engineer has previously
     * been saved, it will retrieve related Tickets from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Engineer.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(EngineerPeer::DEFAULT_STRING_FORMAT);
    }

...
abstract class BaseTicketType extends BaseObject implements Persistent
{
     ...
     * @return TicketType The current object (for fluent API support)
     */
    public function setTicketTypeId($v)
    {
        ...
        if ($this->ticket_type_id !== $v) {
            ...
            $this->modifiedColumns[] = TicketTypePeer::TICKET_TYPE_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = TicketTypePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->ticket_type_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 2; // 2 = TicketTypePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TicketTypeQuery::create()
    ...
    {
        if (isset($alreadyDumpedObjects['TicketType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TicketType'][$this->getPrimaryKey()] = true;
        $keys = TicketTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getTicketTypeId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setTicketTypeId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TicketTypePeer::TICKET_TYPE_ID)) $criteria->add(TicketTypePeer::TICKET_TYPE_ID, $this->ticket_type_id);
        if ($this->isColumnModified(TicketTypePeer::NAME)) $criteria->add(TicketTypePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(TicketTypePeer::DATABASE_NAME);
        $criteria->add(TicketTypePeer::TICKET_TYPE_ID, $this->ticket_type_id);
    ...
    /**
     * Generic method to set the primary key (ticket_type_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getTicketTypeId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of TicketType (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setTicketTypeId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TicketType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this TicketType is new, it will return
    ...
    public function setTickets(PropelCollection $tickets, PropelPDO $con = null)
    {
        ...
        foreach ($ticketsToDelete as $ticketRemoved) {
            $ticketRemoved->setTicketType(null);
        }
    ...
    {
        return (string) $this->exportTo(TicketTypePeer::DEFAULT_STRING_FORMAT);
    }

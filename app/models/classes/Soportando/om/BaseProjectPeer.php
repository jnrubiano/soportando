...
abstract class BaseProjectPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('ProjectId', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('projectId', 'name', ),
        BasePeer::TYPE_COLNAME => array (ProjectPeer::PROJECT_ID, ProjectPeer::NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PROJECT_ID', 'NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('project_id', 'name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('ProjectId' => 0, 'Name' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('projectId' => 0, 'name' => 1, ),
        BasePeer::TYPE_COLNAME => array (ProjectPeer::PROJECT_ID => 0, ProjectPeer::NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PROJECT_ID' => 0, 'NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('project_id' => 0, 'name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        // Invalidate objects in PackagePeer instance pool,
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ProjectPeer::PROJECT_ID) && $criteria->keyContainsValue(ProjectPeer::PROJECT_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ProjectPeer::PROJECT_ID);
            $value = $criteria->remove(ProjectPeer::PROJECT_ID);
            if ($value) {
                $selectCriteria->add(ProjectPeer::PROJECT_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ProjectPeer::PROJECT_ID, (array) $values, Criteria::IN);
        }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related Package objects
            $criteria = new Criteria(PackagePeer::DATABASE_NAME);

            $criteria->add(PackagePeer::PROJECT_ID, $obj->getProjectId());
            $affectedRows += PackagePeer::doDelete($criteria, $con);
        }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ProjectPeer::DATABASE_NAME);
        $criteria->add(ProjectPeer::PROJECT_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ProjectPeer::DATABASE_NAME);
            $criteria->add(ProjectPeer::PROJECT_ID, $pks, Criteria::IN);

...
abstract class BaseCustomer extends BaseObject implements Persistent
{
    ...
    public function setCid($v)
    {
        ...
        if ($this->cid !== $v) {
            $this->cid = $v;
            $this->modifiedColumns[] = CustomerPeer::CID;
        }
    ...
    public function setTel($v)
    {
        ...
        if ($this->tel !== $v) {
            $this->tel = $v;
            $this->modifiedColumns[] = CustomerPeer::TEL;
        }
    ...
    /**
     * Set the value of [cel] column.
     *
     * @param string $v new value
     * @return Customer The current object (for fluent API support)
     */
    public function setCel($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->cel !== $v) {
            $this->cel = $v;
            $this->modifiedColumns[] = CustomerPeer::CEL;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[] = CustomerPeer::UID;
        }
    ...
    public function setCompanyId($v)
    {
        ...
        if ($this->company_id !== $v) {
            $this->company_id = $v;
            $this->modifiedColumns[] = CustomerPeer::COMPANY_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->cid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->tel = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->cel = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = CustomerPeer::CID;
        if (null !== $this->cid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CustomerPeer::CID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CustomerPeer::CID)) {
            $modifiedColumns[':p' . $index++]  = '`cid`';
        }
        if ($this->isColumnModified(CustomerPeer::TEL)) {
            $modifiedColumns[':p' . $index++]  = '`tel`';
        }
        if ($this->isColumnModified(CustomerPeer::CEL)) {
            $modifiedColumns[':p' . $index++]  = '`cel`';
        }
        if ($this->isColumnModified(CustomerPeer::UID)) {
            $modifiedColumns[':p' . $index++]  = '`uid`';
        }
        if ($this->isColumnModified(CustomerPeer::COMPANY_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`tel`':
                        ...
                        break;
                    case '`cel`':
                        $stmt->bindValue($identifier, $this->cel, PDO::PARAM_STR);
                        break;
                    case '`uid`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setTel($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setCel($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CustomerPeer::CID)) $criteria->add(CustomerPeer::CID, $this->cid);
        if ($this->isColumnModified(CustomerPeer::TEL)) $criteria->add(CustomerPeer::TEL, $this->tel);
        if ($this->isColumnModified(CustomerPeer::CEL)) $criteria->add(CustomerPeer::CEL, $this->cel);
        if ($this->isColumnModified(CustomerPeer::UID)) $criteria->add(CustomerPeer::UID, $this->uid);
        if ($this->isColumnModified(CustomerPeer::COMPANY_ID)) $criteria->add(CustomerPeer::COMPANY_ID, $this->company_id);
    ...
    {
        $criteria = new Criteria(CustomerPeer::DATABASE_NAME);
        $criteria->add(CustomerPeer::CID, $this->cid);
    ...
    public function getCompany(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCompany === null && ($this->company_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompany->addCustomers($this);
             */
        }
    ...
    public function setTickets(PropelCollection $tickets, PropelPDO $con = null)
    {
        ...
        foreach ($ticketsToDelete as $ticketRemoved) {
            $ticketRemoved->setCustomer(null);
        }

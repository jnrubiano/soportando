...
abstract class BaseRol extends BaseObject implements Persistent
{
    ...
    public function setRid($v)
    {
        ...
        if ($this->rid !== $v) {
            $this->rid = $v;
            $this->modifiedColumns[] = RolPeer::RID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RolPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = RolPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = RolPeer::RID;
        if (null !== $this->rid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . RolPeer::RID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(RolPeer::RID)) {
            $modifiedColumns[':p' . $index++]  = '`rid`';
        }
        if ($this->isColumnModified(RolPeer::NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RolPeer::RID)) $criteria->add(RolPeer::RID, $this->rid);
        if ($this->isColumnModified(RolPeer::NAME)) $criteria->add(RolPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(RolPeer::DATABASE_NAME);
        $criteria->add(RolPeer::RID, $this->rid);

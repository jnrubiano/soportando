...
abstract class BaseCompanyPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('CompanyId', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('companyId', 'name', ),
        BasePeer::TYPE_COLNAME => array (CompanyPeer::COMPANY_ID, CompanyPeer::NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('COMPANY_ID', 'NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('company_id', 'name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('CompanyId' => 0, 'Name' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('companyId' => 0, 'name' => 1, ),
        BasePeer::TYPE_COLNAME => array (CompanyPeer::COMPANY_ID => 0, CompanyPeer::NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('COMPANY_ID' => 0, 'NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('company_id' => 0, 'name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(TicketPeer::COMPANY_ID, $obj->getCompanyId());
